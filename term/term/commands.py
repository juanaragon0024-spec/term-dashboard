...
COMMAND_GROUPS: dict[str, dict[str, str]] = {
    ...
    "grp_ai": {
        ...
        "/permissions [nivel]":   "Qué puede hacer la IA (lectura, normal, todo)",
        "/allow [nivel]":         "Lo mismo que /permissions",
    ...
    "grp_git": {
        "/git":                   "Panel de git: preparar archivos y confirmar (ctrl+g)",
        ...
        "/prs":                   "Pull requests abiertas",
        "/issues":                "Incidencias abiertas",
        "/pr <n>":                "Ver una pull request",
        "/issue <n>":             "Ver una incidencia",
        "/pr-checkout <n>":       "Traer la rama de una pull request",
        "/issue-new <título>":    "Abrir una incidencia",
        "/repo":                  "Datos del repositorio en GitHub",
    },
    "grp_files": {
        ...
        "/f":                     "Buscador difuso de archivos (también ctrl+p)",
